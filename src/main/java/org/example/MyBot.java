...
public class MyBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        if (update.hasCallbackQuery()) {
            ...
            try {
                ...
                String savePath = "C:\\Users\\abulfayz\\Desktop\\audios\\"+fileName;
    ...
    public List<String> fileSearch(String musicName){
        String folderPath = "C:\\Users\\abulfayz\\Desktop\\audios";
    ...
    public String getBotUsername() {
        return "boom_abulfayz_bot";
    }

    @Override
    public String getBotToken() {
        return "6284537469:AAEAaLzCcqgvluYkQqfqLlxJR9adfXBnRn8";
    }
}